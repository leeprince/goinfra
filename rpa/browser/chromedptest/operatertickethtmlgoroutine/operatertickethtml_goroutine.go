...
const (
	...
	ticketHtmlFileDir  = "/Users/leeprince/www/go/goinfra/rpa/browser/chromedptest/operatertickethtmlgoroutine"
)
...
func main() {
	...
	*/
	...
	if result.ResultType == string(ResultTypeSuccess) {
		...
		err = errorGroup.Wait()
		if err != nil {
			log.Fatal("errorGroup.Wait() err:", err)
		}
	}
