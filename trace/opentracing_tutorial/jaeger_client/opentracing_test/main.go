...
func main() {
    ...
    plog.WithFiledLogID(jaeger_client.TraceID(spanCtx)).Infof("main TraceID")
...
func RPCTraceFormatter(ctx context.Context) {
    ...
    if err != nil {
        jaeger_client.PlogError(spanCtx, "RPCTraceFormatter jaeger_client.HTTPClient err:", err)
        return
    }
