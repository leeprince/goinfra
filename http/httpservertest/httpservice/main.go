...
var (
	...
	// 【推荐】基于运行 main 入口函数时的工作目录的相对路径; 如goland则需要看运行是指定的`Working directory`,一般工作目录就是该项目所在目录=/Users/leeprince/www/go/goinfra/
	resoureDir = "./http/httpservertest/httpservice/resource"

	dataDir = "./http/httpservertest/httpservice/data"
)
