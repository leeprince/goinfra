...
var ticketHtmlReadFile20230820Once sync.Once

func ticketHtmlReadFile20230820(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "text/html; charset=utf-8")
	
	currentResoureDir := path.Join(resoureDir, "ticketHtmlReadFile20230820")
	...
	*/
	ticketHtmlReadFile20230820Once.Do(func() {
